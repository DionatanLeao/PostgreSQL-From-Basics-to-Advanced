...
DELETE FROM FUN WHERE FUNNUM = 8369;

DELETE FROM FUN WHERE NOT EXISTS (SELECT * FROM AREA WHERE AREA.DEPTNUM = FUN.DEPTNUM);
...
DELETE FROM FUN WHERE DEPTNUM NOT IN (SELECT DEPTNUM FROM AREA);

CREATE TABLE TESTE (ID INTEGER, NOME VARCHAR(10));

INSERT INTO TESTE VALUES (1, 'SILVIA'),
                            (2, 'ALAN'),
                                (3, 'ALAN'),
                                    (4, 'JOAO'),
                                        (5, 'JOAO'),
